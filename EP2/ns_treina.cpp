...
int main(int argc, char** argv) {
    ...
    ARQCSV a(nome_dir + "ns_treino.csv");
    ARQCSV v(nome_dir + "ns_valida.csv");

    /* --10 epochs --47.3s --96% valida e 94% teste*/
    ...
    //cout << omelhor << " " << total << endl;
    net.save("ns_rede_2.net");
